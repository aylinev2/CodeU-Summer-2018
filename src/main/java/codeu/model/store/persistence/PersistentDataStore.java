...
public class PersistentDataStore {
  ...
  public List<User> loadUsers() throws PersistentDataStoreException {
    ...
    for (Entity entity : results.asIterable()) {
      try {
        ...
        Boolean privileges = Boolean.parseBoolean((String) entity.getProperty("privileges"));
        User user = new User(uuid, userName, aboutMe, passwordHash, creationTime, privileges);
        users.add(user);
      } catch (Exception e) {
  ...
  /**
   * Loads all Marker from the Datastore service and returns them in a List
   *
   * @throws PersistentDataStoreException if an error was detected during the load from the
   *     Datastore service
   */
  public List<Marker> loadMarkers() throws PersistentDataStoreException {
    ...
    // Retrieve all markers from the datastore.
    Query query = new Query("chat-markers");
    PreparedQuery results = datastore.prepare(query);
  ...
  public void writeThrough(User user) {
    ...
    userEntity.setProperty("privileges", Boolean.toString(user.hasPrivileges()));
